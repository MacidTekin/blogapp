            ...
            if(context != null)
            {
                ...
                if(!context.Users.Any())
                {
                    context.Users.AddRange(
                        new User { UserName = "macidtekin", Name = "Macid Tekin", Email="mcdtkn35@gmail.com", Password ="123456" ,Image = "p1.jpg"},
                        new User { UserName = "tekinmacid", Name = "Tekin Macid", Email="mcdtkn35@gmail.com", Password ="123456" ,Image = "p2.jpg"}
                    );
                    context.SaveChanges();
                }
